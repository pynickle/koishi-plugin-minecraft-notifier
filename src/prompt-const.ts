...
2. Subcategory Object Structure (MUST use "subcategory" as field name):
   - Each subcategory object MUST have exactly three fields: "subcategory", "emoji", "items"
   - Example:
     {
       "subcategory": "生物群系",
       "emoji": "🌍",
       "items": ["新增深暗地域生物群系", "优化地形生成算法"]
     }
   - IMPORTANT: The field name MUST be "subcategory", NOT "name" or any other variant.
